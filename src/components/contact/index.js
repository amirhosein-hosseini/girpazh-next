...
const Contact = () => {
    ...
    return(
        <div className={styles.contact + " mb-20"}>
            ...
            <div className={styles.desc + " container w-11/12 mx-auto mt-20 mb-20"}>
                <p className="font-bold text-2xl mb-5 max-md:text-xl">
                    راه‌‌های ارتباطی با گیرپاژ
                </p>
                <p className="w-full ml-auto mb-10 max-md:text-sm max-md:w-full">
                    برای ارتباط با کارشناسان گیرپاژ می‌توانید از راه‌های ارتباطی زیر استفاده کنید. همچنین در صورت نیاز نیز می‌توانید با ارسال نظرات خود، مارا در ارائه هر چه بهتر خدمات گیرپاژ یاری کنید.
                </p>
                <div className="flex flex-col gap-4">
                    <div className="flex items-cetner gap-2 justify-end">
                        <p className="text-sm max-md:text-xs" style={{direction: "ltr"}}>
                            0902 887 1800
                        </p>
                    ...
                    <div className={styles.email + " w-6/12 max-md:w-full max-md:mt-10"}>
                        <div className={styles.emailInput + " max-md:mt-2 text-right flex flex-col"}>
                            <p className="mb-2 text-xs text-center">
                                برای اطلاع از آخرین اخبار ایمیل خود را ثبت نمایید.
                            </p>
                            <form>
